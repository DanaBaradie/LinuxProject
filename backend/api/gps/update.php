...
try {
    ...
    try {
        ...
        // Trigger notification checks (run asynchronously if possible)
        require_once __DIR__ . '/../../services/notification-service.php';
        $notificationService = new NotificationService();
        
        // Check if bus is nearby stops
        $notificationService->checkBusNearby($busId, $latitude, $longitude);
        
        // Check speed warnings
        if ($speed > 0) {
            $notificationService->checkSpeedWarning($busId, $speed);
        }
