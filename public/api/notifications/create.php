...
$busId = isset($input['bus_id']) && !empty($input['bus_id']) ? intval($input['bus_id']) : null;
...
try {
    ...
    sendJsonResponse(true, ['notification' => $notification], 'Notification sent successfully', 201);
